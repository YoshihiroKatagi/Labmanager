    ...
    <div class="container-fluid" style="display:flex">
        ...
        <div class="col-md-1" style="margin:10px;">
            ...
            <div class="list-group list-group-flush">
              ...
              <a href="/mypage/mytask/thismonth" class="list-group-item list-group-item-action active">This Month</a>
            </div>
        </div>
        
        <!-- Todoリスト -->
        <div class="col-md-5">
            <h1>Mytask -This Month</h1>
            ...
            <div class="card" style="margin:10px;">
                ...
                <form class="row g-2" action="/mypage/mytask/thismonth" method="POST" style="margin:10px;">
                  @csrf
                  <div class="col-md-11">
                  ...
                  <input type="hidden" name="mytask[will_finish_on]" value="{{ \Carbon\Carbon::now()->endOfMonth() }}">
                  <div class="col-md-2">
                        ...
                        @foreach($mytasks_todo as $mytask)
                            @if($mytask->labtask->user_id == Auth::user()->id)
                                <tr>
                                  ...
                                  <td><a href="/mypage/mytask/thismonth/{{ $mytask->id }}">{{ $mytask->title }}</a></td>
        ...
        <div class="col-md-4">
            <div class="card" style="padding:10px; margin:15px; margin-top:60px;">
                <button type="button" class="btn-close" aria-label="Close" onclick="location.href='/mypage/mytask/thismonth'"></button>
                <h2>Detail & Edit</h2>
