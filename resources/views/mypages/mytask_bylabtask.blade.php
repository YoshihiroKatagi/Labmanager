    ...
    <div class="container-fluid" style="display:flex">
        ...
        <div class="col-md-2" style="margin:10px;">
            <div class="list-group list-group-flush">
              ...
              @foreach($labtasks as $labtask)
                @if($labtask->id == $Labtask->id)
                    <a href="/mypage/mytask/bylabtask/{{ $labtask->id }}" class="list-group-item list-group-item-action active">
                      {{ $labtask->title }}
                    </a>
                @else
        ...
        <div class="col-md-7">
            ...
            <div class="card" style="margin:10px;">
                ...
                <form class="row g-2" action="/mypage/mytask/bylabtask/{{ $Labtask->id }}" method="POST" style="margin:10px;">
                  @csrf
                  <div class="col-md-11">
                        ...
                        @foreach($mytasks_todo as $mytask)
                            @if($mytask->labtask->user_id == Auth::user()->id)
                                <tr>
                                  ...
                                  <td><a href="/mypage/mytask/bylabtask/{{ $Labtask->id }}/{{ $mytask->id }}">{{ $mytask->title }}</a></td>
